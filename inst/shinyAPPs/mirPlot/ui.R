...
library("shinythemes")
ui <- navbarPage("mirPlot v2",theme = shinytheme("flatly"),
...
tabPanel(title='Load Data',
 ...
 radioButtons("matureorarm", "Are you uploading mature/star sequences or 5p/3p ?",
        ...
        tags$hr(),
        actionButton("ButtonFold", "2- Fold sequences (might take a long time)"),
        # Horizontal line ----
        tags$hr(),
...
#        tags$hr(),
        actionButton("ButtonExp", "3- Calculate expression"),
        tags$hr(),
        actionButton("Homology", "4- Conservation"),
        tags$hr(),
        actionButton("ButtonIntegrate", "5- Intergrate")#,
        #tags$hr(),
        #bookmarkButton()
...
# Main panel for displaying outputs ----
      mainPanel(
          ...
          fluidRow(
            ...
            column(6,
                   h4("1- get Sequences"),
                   h5("~ mirPlot takes the information about the miRNA sequence from genome (using the provided gff3)."),
          ...
          fluidRow(
            column(6,
                   h4("2- Fold sequences"),
                   h5("~ mirPlot calculates the secondary structure of the extended precursor"),
            ...
            column(6,
                   ...
                   img(src="/appfigs/Bge-Mir-1_pre.png" ,width="600" , height="300")
            )
          ),
          fluidRow(
            ...
            column(6,
                   h4("4- Conservation"),
                   h5("~ mirPlot takes the mature seqeucne and aligns against miRBase"),
